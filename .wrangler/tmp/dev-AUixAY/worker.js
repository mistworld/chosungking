...
async function handleChat(request, env) {
  const { roomId, playerId, playerName, message } = await request.json();
...
// .wrangler/tmp/bundle-6NjvmL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-6NjvmL/middleware-loader.entry.ts
