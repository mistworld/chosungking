    ...
    for (const key of list.keys) {
      try {
        ...
        if (meta && meta.id) {
          ...
          if (!meta.gameStarted && now - meta.createdAt < ONE_HOUR && playerCount > 0) {
            rooms.push({
              id: meta.id,
          ...
          if (roomData && !roomData.gameStarted && now - roomData.createdAt < ONE_HOUR && playerCount > 0) {
...
// .wrangler/tmp/bundle-V1fVjY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-V1fVjY/middleware-loader.entry.ts
