  ...
  try {
    ...
    for (let i = 0; i < list.keys.length; i++) {
      ...
      try {
        ...
        if (isNewRoom) {
          console.log(`[rooms] \uC0C8 \uBC29 ${roomId}: players.length=${players.length}, playerCount=${playerCount}`);
        }
...
// .wrangler/tmp/bundle-xZJtCM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xZJtCM/middleware-loader.entry.ts
